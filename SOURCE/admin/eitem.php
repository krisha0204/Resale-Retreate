...
if (strlen($_SESSION['agmsaid']==0)) {
  header('location:logout.php');
    ...
    if (isset($_POST['update'])) {
        ...
        if ($conn) {
            $query = "UPDATE item SET type='$ptype', pname='$name', height='$pheight', width='$pwidth', length='$plength', pdate='$prdate', edate='$exdate', cost='$pcost', info='$des', photo='$img', name='$oname', address='$add', pincode='$pinc', contact='$cont' WHERE id='$id'";
...
<head>
  <title>Update Item | Resale Retreate</title>
   ...
   <?php include_once('includes/sidebar.php');?>
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Update Item</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="productType" name="productType" required>
                                ...
                                foreach ($submenu_items as $submenu_item) {
                                    $selected = ($submenu_item['c_id'] == $item['id']) ? 'selected' : '';
                                    echo '<option value="' . $submenu_item['c_id'] . '"' . $selected . '>' . $submenu_item['c_name'] . '</option>';
                                }
                                ?>
                            </select>
                        </div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input class="form-control" id="productname" name="productname" type="text" value="<?php echo $item['pname']; ?>" required="true">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Product Height (in inches)</label>
											<div class="col-sm-10">
												<input class="form-control" id="productHeight" name="productHeight" type="text" placeholder="inches" value="<?php echo $item['height']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Product Width (in inches)</label>
											<div class="col-sm-10">
												<input class="form-control" id="productWidth" name="productWidth" type="text" placeholder="inches" value="<?php echo $item['width']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-2 control-label">Product Length (in inches)</label>
											<div class="col-sm-10">
												<input class="form-control" id="productLength" name="productLength" type="text" placeholder="inches" value="<?php echo $item['length']; ?>">
											</div>
										</div>
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" id="purchaseDate" name="purchaseDate" type="date" required="true"  value="<?php echo $item['length']; ?>">
                                        </div>
                                    </div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="form-control" id="expiryDate" name="expiryDate" type="date" value="<?php echo $item['edate']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Cost</label>
										<div class="col-sm-10">
											<input class="form-control" id="cost" name="cost" type="number" placeholder="in rupees" value="<?php echo $item['cost']; ?>" required="true">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Description</label>
										<div class="col-sm-10">
											<textarea class="form-control" id="Description" name="Description"><?php echo $item['info']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input class="form-control" id="owner_name" name="owner_name" type="text" value="<?php echo $item['name']; ?>" required="true">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Address Info</label>
										<div class="col-sm-10">
											<textarea class="form-control" id="address" name="address" required="true"><?php echo $item['address']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Pincode</label>
										<div class="col-sm-10">
											<input class="form-control" id="pincode" name="pincode" type="text" value="<?php echo $item['pincode']; ?>" required="true">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-2 control-label">Contact</label>
										<div class="col-sm-10">
											<input class="form-control" id="contact" name="contact" type="text" value="<?php echo $item['contact']; ?>" required="true">
										</div>
									</div>
