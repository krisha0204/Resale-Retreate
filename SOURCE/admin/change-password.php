...
// Debugging: Output the hashed current password
echo '<script>console.log("Hashed Current Password: ' . $cpassword . '");</script>';

$query=mysqli_query($conn,"select id, password from admin where id='$adminid'");
$row=mysqli_fetch_array($query);

// Debugging: Output the hashed password from the database
echo '<script>console.log("Database Password: ' . $row['password'] . '");</script>';
...
<head>
  <title>Change Password | Resale Retreate</title>
